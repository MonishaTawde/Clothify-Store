<%@ Page Title="" Language="C#" MasterPageFile="~/Root/User.Master" AutoEventWireup="true" CodeBehind="Payment.aspx.cs" Inherits="NyraShopping.Root.Payment" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
  ...
  <h3>Choose Payment Mode</h3>
            ...
            <ul class="nav nav-tabs">
             ...
             <div class="tab-content">
                <div id="wallets" class="tab-pane fade show active">
                    <h3>HOME</h3>
                    <p>Some content.</p>
                    <asp:Button ID="btnPaytm" OnClick="BtnPaytm_Click" runat="server" Text="Pay with Paytm" />  </div>
    ...
    <div class ="container ">
        ...
        <p>&copy;2024 Clothify.in &middot; <a href ="Default.aspx">Home</a>&middot;<a href ="Default.aspx">Products</a> </p>
    </div>
