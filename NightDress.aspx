<%@ Page Title="" Language="C#" MasterPageFile="~/Root/User.Master" AutoEventWireup="true" CodeBehind="NightDress.aspx.cs" Inherits="NyraShopping.Root.NightDress" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
<title>Kids:Clothes Online Shopping</title>
</asp:Content>
...
<div class="container">
  <h2>Night Dress</h2>  
    ...
    <div class="panel panel-primary">
      <div class="panel-heading">Women Sarees</div>
    ...
    <asp:Repeater ID="rptrProducts" runat="server">
     ...
     <footer>
    <div class ="container ">
        <p class ="pull-right "><a href ="Kids.aspx">Back to top</a></p>
<p>&copy;2024 Clothify.in &middot; <a href ="Default.aspx">Home</a>&middot;<a href ="About.aspx">About</a>&middot;<a href ="Products.aspx">Products</a> </p>
