<%@ Page Title="" Language="C#" MasterPageFile="~/Root/User.Master" AutoEventWireup="true" CodeBehind="BottomWear.aspx.cs" Inherits="NyraShopping.Root.BottomWear" %>
...
<div class="container">
  <h2>Bottom Wear</h2>  
    ...
    <div class="panel panel-primary">
      <div class="panel-heading">Bottom Wear</div>
    ...
    <asp:Repeater ID="rptrProducts" runat="server">
     ...
     <footer>
    <div class ="container ">
        <p class ="pull-right "><a href ="Men.aspx">Back to top</a></p>
        <p>&copy;2024 NyraFashion.in &middot; <a href ="Default.aspx">Home</a>&middot;<a href ="About.aspx">About</a>&middot;<a href ="Products.aspx">Products</a> </p>
    </div>
    ...
    <script type="text/javascript">
        function Search_Gridview(strKey) {
            ...
            for (var i = 1; i < tblData.rows.length; i++) {
                rowData = tblData.rows[i].innerText.toLowerCase();
