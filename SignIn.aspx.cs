    ...
    public partial class SignIn : System.Web.UI.Page
    {
        ...
        protected void BtnLogin_Click(object sender, EventArgs e)
        {
            using (SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings["NyraShoppingDB"].ConnectionString))
            {
                ...
                {
                    ClientScript.RegisterClientScriptBlock(this.GetType(), "k", "swal('Invaliddd Userr','Unsuccessfull Login. Try Again','error')", true);
                ...
                Clr();
                con.Close();
                //lblError.Text = "Registration Successfully done";
