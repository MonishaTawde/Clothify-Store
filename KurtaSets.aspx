<%@ Page Title="" Language="C#" MasterPageFile="~/Root/User.Master" AutoEventWireup="true" CodeBehind="KurtaSets.aspx.cs" Inherits="NyraShopping.Root.KurtaSets" %>
...
<div class="container">
  <h2>Kurta & Sets</h2>  
    ...
    <asp:Repeater ID="rptrProducts" runat="server">
     ...
     <footer>
    <div class ="container ">
        <p class ="pull-right "><a href ="Women.aspx">Back to top</a></p>
        <p>&copy;2024 Clothify.in &middot; <a href ="Default.aspx">Home</a>&middot;<a href ="Products.aspx">Products</a>&middot;<a href ="About.aspx">About</a> </p>
    </div>
