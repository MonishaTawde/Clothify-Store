...
namespace NyraShopping.Root
{
    public partial class SubCategory : System.Web.UI.Page
    {
        ...
        private void BindSubCatRptr()
        {
            ...
            {
                using (SqlCommand cmd = new SqlCommand("select A.SubCatID, A.SubCatName, B.CatName from tblSubCategory A inner join tblCategory B on B.CatID = A.MainCatID", con))
                {
                    con.Open();
